...
namespace SSMS.Model
{
    ...
    {
        public Student(string dbNumber, string name, string gender, string id, string post, string cardid, string dataPath)
        {
            DbNumber = dbNumber;
            Name = name;
            Gender = gender;
        ...
        public string StudyTime { get { return studyTime; } set { studyTime = value; } }
    }
}
